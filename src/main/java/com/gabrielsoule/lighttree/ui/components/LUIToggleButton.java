...
import com.gabrielsoule.lightui.ToggleComponent;

import java.util.function.Supplier;

public class LUIToggleButton extends ToggleComponent {
    ...
    public LUIToggleButton(String name, String text) {
        this(name, text, 24, () -> LightTree.getInstance().newUI.uiGradient.get(0.7f),3);
    }

    public LUIToggleButton(String name, String text, int textSize, Supplier<Integer> colorSupplier, int strokeWidth) {
        super(name);
        ...
        this.text.setTextVerticalOffset(-0.05f);
